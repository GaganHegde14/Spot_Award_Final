...
import "../styles//RM_PM_Inititation/Avatars.css";
import Header from "./Header";
import EmployeeProfile from "./EmployeeProfile";
import RequiredInfo from "./RequiredInfo9";
import SpotAwardRequest from "./SpotAwardRequest9";
  ...
  return (
    <div className="avatars-container">
      <Header
        ...
        title={
          <>
            <span>Spot Award Request</span>{" "}
            <span
              className="page-title-suffix"
              style={{ fontSize: "0.6em", fontWeight: 500 }}
            >
              - (RM/PM Initiation)
            </span>
          </>
