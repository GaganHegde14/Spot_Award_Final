...
import "../styles/Initator_Confirmation/Avatars.css";
import Header from "./Header";
import EmployeeProfile from "./EmployeeProfile";
import RequiredInfo from "./RequiredInfo6";
import SpotAwardRequest from "./Spotaward6";
  ...
  return (
    <div className="avatars-container">
      <Header
        ...
        title="Spot Award Request - (Initiator Confirmation)"
